<div class="w-screen h-screen bg-stone-800">
	<div class="fixed top-20 left-8">
		<p class="text-xl font-noto font-black text-zinc-200">404<br /> NOT FOUND</p>
	</div>
	<div class="fixed bottom-20 right-8">
		<p class="text-xl font-noto font-black text-zinc-200 text-right">404<br /> NOT FOUND</p>
	</div>
	<div class="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
		<div>
			<h1 class="text-4xl font-noto font-black -rotate-12 text-zinc-200">Opps!</h1>
			<h2 class="text-2xl font-noto font-bold ml-14 mt-6 text-zinc-200">打工人失蹤了！</h2>
		</div>
		<div class="flex flex-row items-center justify-center mt-14 gap-4">
			<a href="/">
				<button
