...
CREATE TABLE IF NOT EXISTS TB_SCHEDULE (schedule_id INTEGER PRIMARY KEY AUTOINCREMENT, schedule_token TEXT, punch_in_id TEXT, schedule_expiration_datetime TEXT);
