...
CREATE TABLE IF NOT EXISTS TB_OTP (otp_id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, otp_key TEXT, otp TEXT, otp_type TEXT, otp_purpose TEXT, otp_argument TEXT, otp_expiration_datetime TEXT);
